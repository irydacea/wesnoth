...
void unit_attack::pre_show(window& window)
{
	...
	for(const auto & weapon : weapons_) {
		...
		attacker_weapon.specials_context(&*attacker_itor_, &*defender_itor_, attacker_itor_->get_location(), defender_itor_->get_location(), true, defender.weapon);
        attacker_weapon.specials_context(&*defender_itor_, &*attacker_itor_, defender_itor_->get_location(), attacker_itor_->get_location(), false, attacker.weapon);
